...
RefererCheck = optionIsOn(refererMatch)
...
function blackip()
	  ...
	  ip_blacklist:flush_all()
          for oneip in file:lines() do
              ip_blacklist:set(oneip, true)
          end
